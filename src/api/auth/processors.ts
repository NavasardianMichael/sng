import { ChangePasswordAPI, InviteUserAPI, LoginAPI, RegisterAPI, ResetPasswordAPI, SendForgotPasswordInstructionsAPI, VerifyTokenAPI } from './types'
...
export const processSendForgotPasswordInstructionsResponse: SendForgotPasswordInstructionsAPI['processor'] = (response) => {
    return response.value
}
